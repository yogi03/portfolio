...
const TargetCursor: React.FC<TargetCursorProps> = ({
  targetSelector = '.cursor-target, a, button, [role="button"], input, textarea, select',
  spinDuration = 2,
  ...
  return (
    <div
      ref={cursorRef}
      className="hidden md:block fixed top-0 left-0 w-0 h-0 pointer-events-none z-[9999]"
