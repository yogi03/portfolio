  ...
  return (
    <div name='Portfolio' className='bg-[#FFFFF0] text-gray-800 md:h-screen py-8 sm:pt-0'>
        <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center h-full w-full '>
            <div className='pb-8 pt-0 sm:pt-40'>
            ...
            <div className='shadow-md shadow-gray-600 rounded-lg'>
                ...
                <div className='shadow-md shadow-gray-600 rounded-lg'>
                    <img src={fashion} alt="Fashion AI" className='rounded-md duration-200 hover:scale-105'/>
                    <div className='flex items-center justify-center'>
                        <a href="https://github.com/yogi03/fashion-ai" target="_blank" rel="noopener noreferrer" className='w-1/2'>
                            <button className='w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105'>Demo</button>
                        </a>
                        <a href="https://github.com/yogi03/fashion-ai" target="_blank" rel="noopener noreferrer" className='w-1/2'>
                            <button className='w-1/2 px-6 py-3 m-4 duration-200 hover:scale-105'>Code</button>
